...
let nameCat = getCatInfo().name
let ageCat = getCatInfo().age
let colorCat = getCatInfo().color

console.log(`${nameCat} é um gato ${colorCat} de ${ageCat} anos.`)
...
let randomNumbersReverse = randomNumbers.reverse()
...
let secondTitle = document.querySelectorAll('.secondary-title')

secondTitle.forEach(title => {
  console.log(title)
})