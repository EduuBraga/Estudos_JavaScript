...
*/
const myObjJSON = '{"name": "eduardo", "age": 18}'

localStorage.setItem('i', myObjJSON)

const valueParsing = key => JSON.parse(localStorage.getItem(key))

console.log(valueParsing('i'))
...
const searchAlbum = albumParam => {
  ...
  console.log('Album não existe no array.')
}

searchAlbum(albumHousesOfTheHoly)
searchAlbum({ id: 1 })
