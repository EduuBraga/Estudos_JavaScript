...
title.innerHTML = title.innerHTML.toLocaleUpperCase()
...
let listNumbers = document.querySelector('.numbers')
...
let numbersLi = document.querySelectorAll('.number')

numbersLi.forEach(number =>{
  let numberOfTheTime = Number(number.innerText)

  if(numberOfTheTime % 2 === 0){
    number.style.color = 'lightblue'
  }
  if(numberOfTheTime % 2 === 1){
